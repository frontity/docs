...
As a Frontity theme creator, you can create **"Slots"** that the users of your theme can later fill in with their own content.
Here's an example:

Let's say that you want to create a theme where your users can place cat pictures in-between a list of menuItems.
Your users will put their `Cat` components in the state like:
