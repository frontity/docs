...
The Frontity CLI (Frontity commands) is packaged as an executable that can be used globally. The Frontity CLI is available via [npm](https://www.npmjs.com/) and can be directly used by running `npx frontity <%frontity-command%>`
